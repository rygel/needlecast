...
object DocRegistry {
    private val all: List<DocTarget> =
        listOf(
            // ── Maven ────────────────────────────────────────────────────────────
            ...
            DocTarget(
                "Dokka Javadoc",
                "build/docs/dokka/javadoc/index.html",
                BuildTool.GRADLE,
                DocCategory.API_DOCS,
    ...
    fun targetsFor(buildTools: Set<BuildTool>): List<DocTarget> = all.filter { it.buildTool in buildTools }
}
