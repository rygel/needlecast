...
class EnvEditorDialog(
    ...
    private val tableModel =
        object : DefaultTableModel(arrayOf("Key", "Value"), 0) {
    ...
    init {
        ...
        val hint =
            JLabel(
                "<html><i>Variables are merged on top of the system environment when running commands and terminals for this project.</i></html>",
            ).apply {
