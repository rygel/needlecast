...
class TourOverlay(
    ...
    private fun showStep() {
        ...
        val target = findPanel(step.panelId) ?: run { nextStep(); return }
        showScrim(target)
    ...
    private fun showBubble(target: java.awt.Component, step: TourStep) {
    ...
    private fun complete() { dispose(); onComplete() }
    private fun skip() { dispose(); onSkip() }
