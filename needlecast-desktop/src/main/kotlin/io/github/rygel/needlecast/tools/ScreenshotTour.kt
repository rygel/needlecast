...
fun main(args: Array<String>) {
    ...
    try {
        ...
        try {
            ...
            System.err.println("overview-full-window failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("overview-light-theme failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("overview-empty-first-launch failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-tree-overview failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-tree-context-menu-folder failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-tree-context-menu-project failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-tree-filter failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-tree-missing-directory failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-tree-led-thinking failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("project-switcher-dialog failed: ${e.message}")
        }
        ...
        try {
            dialogShot(robot, outputDir.resolve("dialog-shell-settings.png")) {
                try {
                    ...
                    val treePanel = treeField.get(w)
                    val method =
                        treePanel.javaClass.getDeclaredMethod(
                            "showShellSettings",
            ...
            System.err.println("dialog-shell-settings failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("dialog-env-editor failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("dialog-tags failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("dialog-color-picker failed: ${e.message}")
        }
        ...
        fun commandsShot(
            ...
            try {
                ...
                System.err.println("$filename failed: ${e.message}")
            }
        }
        ...
        try {
            ...
            System.err.println("commands-history failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("commands-queue failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("commands-readme-preview failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("console-output failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("console-find-bar failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("terminal-active failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("terminal-multiple-tabs failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("terminal-placeholder failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("terminal-font-zoom failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-overview failed: ${e.message}")
        }
        ...
        try {
            SwingUtilities.invokeAndWait {
                try {
                    ...
                    if (readmeFile.exists()) {
                        explorerPanel.javaClass
                            .getMethod(
                                "openFile",
                                File::class.java,
                            ).invoke(explorerPanel, readmeFile)
                    }
            ...
            System.err.println("editor-multiple-tabs failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-find-bar failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-find-replace-bar failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-toolbar failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-open-with-menu failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-large-file failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-syntax-themes failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-unsaved-dialog failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("editor-tab-context-menu failed: ${e.message}")
        }
        ...
        try {
            SwingUtilities.invokeAndWait {
                try {
                    ...
                    val explorerPanel = explorerField.get(w)
                    explorerPanel.javaClass
                        .getMethod("setRootDirectory", File::class.java)
            ...
            System.err.println("explorer-overview failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("explorer-context-menu-file failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("explorer-context-menu-folder failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("explorer-hidden-files-on failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("explorer-hidden-files-off failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("explorer-address-bar-editing failed: ${e.message}")
        }
        ...
        try {
            SwingUtilities.invokeAndWait {
                try {
                    ...
                    logViewerPanel.javaClass
                        .getMethod("loadProject", String::class.java)
            ...
            System.err.println("logviewer-overview failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("logviewer-level-filters failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("logviewer-stack-trace failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("logviewer-search failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("logviewer-follow-button failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("renovate-not-installed failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("search-overview failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("search-options failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("search-result-count failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("search-editor-jump failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("git-branch-badges failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("gitlog-overview failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("gitlog-commit-selected failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("prompt-input-panel failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("prompt-library-dialog failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("prompt-variable-dialog failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("command-library-dialog failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("ai-tools-menu failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("docs-panel-rendered failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("docs-panel-raw failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("settings-color-picker failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("theme-menu failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("viewer-image failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("viewer-svg failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("docking-tabs-bottom failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("panels-menu failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("status-bar-update-badge failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("about-dialog failed: ${e.message}")
        }
        ...
        try {
            dialogShot(robot, outputDir.resolve("import-config-dialog.png")) {
                val chooser =
                    javax.swing.JFileChooser(File(System.getProperty("user.home"))).apply {
            ...
            System.err.println("import-config-dialog failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("add-project-dialog failed: ${e.message}")
        }
        ...
        try {
            ...
            System.err.println("delete-confirmation failed: ${e.message}")
        }
...
private fun selectDockableByField(
    w: MainWindow,
    fieldName: String,
) {
...
private fun findTextFieldByPlaceholder(
...
private fun findButtonByTextContains(
    container: java.awt.Container,
    text: String,
): javax.swing.JButton? {
    for (i in 0 until container.componentCount) {
...
private fun <T : java.awt.Container> findFirstComponent(
    container: java.awt.Container?,
    type: Class<T>,
): T? {
...
private fun screenshotTopDialog(
    robot: Robot,
    dest: Path,
) {
    SwingUtilities.invokeAndWait {
...
private fun waitForProjectTreeData(
    window: MainWindow,
...
private fun buildDemoLog(): String =
    buildString {
        ...
        appendLine(
            "10:23:46.012 [main] INFO  io.example.db.ConnectionPool - Database connection established: jdbc:postgresql://localhost:5432/mydb",
        )
        ...
        appendLine(
            "10:23:54.500 [scheduler-1] DEBUG io.example.jobs.CleanupJob - Running scheduled cleanup: removing sessions older than 24h",
        )
